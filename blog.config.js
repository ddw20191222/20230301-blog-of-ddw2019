...
const BLOG = {
  ...
  NOTION_PAGE_ID: process.env.NOTION_PAGE_ID || '0fe30d2152ec46918e9108929ac3264c',
  ...
  AUTHOR: process.env.NEXT_PUBLIC_AUTHOR || '糖糖读书会', // 您的昵称 例如 tangly1024
  BIO: process.env.NEXT_PUBLIC_BIO || '一群爱读书的唐社小伙伴', // 作者简介
